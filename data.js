...
const Maths_Question = [
  ...
  {
    Question_Text: "The locus of the point, which moves such that its distance from (1, −2, 2) is unity, is",
    Options: ["x2+ y2+ z2 − 2x + 4y − 4z + 8 = 0", "x2 + y2 + z2 − 2x − 4y − 4z + 8 = 0","x2+ y2+ z2 + 2x + 4y − 4z + 8 = 0" ,"x2+ y2+ z2 − 2x + 4y + 4z + 8 = 0"],
    Answer: 0,
    Tags: ["Maths", "Coordinate Geometry"],
    Level: 3,
    Image: "",
  ...
  {
    Question_Text: "The plane passing through the point (a, b, c) and parallel to the plane x + y + z = 0 is",
    Options: ["x + y + z = a + b + c", "x + y + z + (a + b + c) = 0", "x + y + z + abc = 0", "ax + by + cz = 0"],
    Answer: 0,
    Tags: ["Maths", "Coordinate Geometry"],
    Level: 4,
    Image: "",
  ...
  {
    Question_Text: "The co-ordinates of the foot of perpendicular from the point A (1, 1, 1) on the line joining the points B (1, 4, 6) and C (5, 4, 4) are",
  ...
  {
    Question_Text: "The length of a line segment whose projections on the coordinate axes are 6, -3, 2, is",
    Options: ["7", "6", "5", "4"],
    Answer: 2,
    Tags: ["Maths", "Conics"],
    Level: 0,
  ...
  {
    Question_Text: "If P, Q, R, S are (3, 6, 4), (2, 5, 2), (6, 4, 4) , (0, 2, 1) respectively then the projection of PQ on RS is",
    Options: ["2", "4", "6", "8"],
    Answer: 0,
    Tags: ["Maths", "Conics"],
    Level: 1,
  ...
  {
    Question_Text: "The equation of the plane passing through the points (2, 1, 2) and (1, 3, 2) and parallel to x- axis is",
  ...
  {
    Question_Text: "The angle between the plane 3x + 4y = 0 and the line x2+ y2 = 0 is",
    Options: ["0", "30", "60", "90"],
    Answer: 0,
    Tags: ["Maths", "Trigonometry"],
    Level: 3,
  ...
  },
  {
    ...
    Options: ["a pair of straight lines", "a pair of parallel lines", "a pair of parallel planes", "a pair of intersecting planes"],
    Answer: 3,
    Tags: ["Maths", "Conics"],
    Level: 2,
    Image: "",
