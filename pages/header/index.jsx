  ...
  return (
    <nav id="navigation-bar" className="flex mt-10 mx-12 w-9/10 h-16 shadow-2xl rounded-full justify-center items-center select-none">
      ...
      <div id="search-bar" className="flex px-8">
        <input type="search" className="flex pl-5 pr-4 mr-1 rounded-l-full w-80 placeholder-cyan-500 text-xs text shadow-md hover:shadow-lg focus:outline-none focus:shadow-inner focus:ring-0  active:shadow-lg transition duration-150 ease-in-out" placeholder="Search"/>
        <div id="search-button" className="h-8 w-9 pl-1 pr-1 pt-0.5 cursor-pointer inline-block leading-tight rounded shadow-md fill-cyan-500 hover:shadow-md hover:shadow-gray-400 active:bg-gradient-to-r from-cyan-500 to-blue-500 active:fill-white active:shadow-lg focus:outline-none focus:ring-4 focus:ring-shadow-2xl transition duration-150 ease-in-out items-center" type="button" >
        ...
        <div id="personal-info" className="flex text-nunito text-right">
          <div className="mt-5">
            ...
            <p id="name" className="text-cyan-500 w-28">Mohit Gupta</p>
          </div> 
          <div id="proficiency">
