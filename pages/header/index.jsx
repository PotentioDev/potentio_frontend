...
export default function Header() {
  return (
    <nav id="navigation-bar" className="flex mt-11 mx-12 w-9/10 h-16 shadow-2xl rounded-full justify-center items-center select-none">
      ...
      <div id="search-bar" className="flex px-8">
        ...
        <div id="search-button" className="h-8  w-9 pl-1 pr-1 pt-0.5 btn cursor-pointer inline-block leading-tight uppercase rounded shadow-md fill-cyan-500 hover:shadow-lg active:bg-gradient-to-r from-cyan-500 to-blue-500 active:fill-white transition duration-150 ease-in-out items-center" type="button" >
